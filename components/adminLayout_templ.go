...
func AdminLayout(payload db.GetUserByIDRow, children ...templ.Component) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "</div><footer class=\"w-full bg-white p-2 dark:bg-black dark:text-gray-400\"><p class=\"block text-sm text-gray-500 sm:text-center \">© ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
